...
Both bucket and user policies are bounded in size: at most 20 statements per policy, 20 actions and 20 resources per statement, and 128 bytes per action/resource pattern. Oversized policies are rejected when loaded.
